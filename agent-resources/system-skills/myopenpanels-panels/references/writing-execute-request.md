...
4. Write the complete result to the declared `outputs/document.md` or
   `outputs/document.txt` artifact.
5. Return the declared execution result. The Task Runtime validates, stages,
   and commits the My Document directly.
