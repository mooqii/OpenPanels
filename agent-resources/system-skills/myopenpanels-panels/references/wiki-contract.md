...
- Treat raw documents, generated Wiki pages, and My Documents as separate
  content layers.
...
- Begin My Document creation or revision before drafting so its target and
  base content version are captured. Stop on `content_conflict`.
