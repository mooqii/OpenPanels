# Generate A Typesetting Cover

Use this reference only inside an exact claimed `generate_typesetting_cover`
Task.
...
4. Write exactly one non-empty `typesetting-cover` artifact at the declared
