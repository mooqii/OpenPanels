...
1. List the available Title Skills and choose the best match. Prefer
   `typesetting-title-default` when the user did not request a specialized
   method.
2. Run `typesetting.title.generate` with the publication id, chosen Skill id,
