 ...
 */
function isPolygonFullyContained(polygon: Point[], rect: Bounds): boolean {
 ...
 */
function rectToPolygon(rect: Bounds): Point[] {
  return [
    { x: rect.x, y: rect.y },
 ...
 */
function getRectEdges(rect: Bounds): [Point, Point][] {
