...
import {
  ...
  getInitialEditingWidthMode,
  getOverlayTransformForTextNode,
  getSelectionFromInput,
  type TextEditOverlay,
  type TextSelectionRange,
  type TextSelectionState,
} from "./text-edit-geometry"

export type { TextEditOverlay, TextEditRect } from "./text-edit-geometry"
