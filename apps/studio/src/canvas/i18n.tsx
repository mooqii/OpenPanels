...
const zhCNMessages: Record<string, string> = {
  ...
  "Delete task": "删除任务",
  "Delete task?": "删除任务？",
  "This task is waiting to run. Deleting it will cancel its related panel content and prevent it from running.":
    "这个任务仍在等待执行。删除后将取消面板中的关联内容，并阻止任务继续执行。",
  ...
  "No Refinement Skills available": "没有可用的 Refinement Skill",
  "Select a Refinement Skill": "请选择一个 Refinement Skill",
