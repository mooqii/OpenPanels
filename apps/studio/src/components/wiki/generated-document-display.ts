...
export function generatedDocumentFormats(
  document: Pick<
    WikiGeneratedDocument,
    "conversion" | "format" | "importSource"
  >
...
export function generatedDocumentConversionDisplay(
  document: Pick<WikiGeneratedDocument, "conversion">
): {
  isFailed: boolean
  isLocked: boolean
