...
export function MyDocumentMeta({
  apiBase,
  document,
  onOpenOriginal,
  status,
  ...
  useEffect(() => {
    ...
    apiJson<{ content?: string }>(
      ...
      .catch(() => {
        // Older documents can still show their last updated date if content is unavailable.
      })
