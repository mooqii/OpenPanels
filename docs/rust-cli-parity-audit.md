...
| Agent protocol | `agent bootstrap`, scoped capability/Guide/Skill discovery | complete | Rust emits budgeted Protocol v4 Bootstrap references, supports multiple referenced required Skill loads, and progressively loads full command and workflow descriptors. |
