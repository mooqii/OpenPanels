...
fn read_active_session_id(paths: &OpenPanelsPaths) -> Result<Option<String>, CliError> {
...
fn panel_file(paths: &OpenPanelsPaths, session_id: &str, panel_id: &str, name: &str) -> PathBuf {
    paths
        .storage_dir
        .join("sessions")
